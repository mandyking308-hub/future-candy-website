...
const GlobalDistribution = () => {
  return (
    <section id="global-distribution" aria-labelledby="global-distribution-heading" className="py-16 md:py-20 bg-background">
          ...
          <div className="relative glass rounded-2xl border border-candy-pink/30 p-6 md:p-10 overflow-hidden shadow-[0_0_40px_rgba(236,72,153,0.15)]">
            ...
            <div className="relative">
              ...
              <div className="space-y-3 text-sm md:text-base text-foreground/80 max-w-3xl">
                ...
                <p className="text-candy-pink/90 font-medium">We make the future sound fun.</p>
              </div>
              <div className="mt-6">
              ...
              <div className="mt-8">
                <div className="flex flex-wrap gap-2">
                  {platforms.map((p) => <span key={p} className="inline-flex items-center rounded-full border border-border/60 bg-card/40 backdrop-blur px-3 py-1 text-xs font-medium text-foreground/85 hover:border-candy-cyan/50 hover:text-candy-cyan transition-colors">{p}</span>)}
                </div>
              </div>
            </div>
          </div>
