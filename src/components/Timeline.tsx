const Timeline = () => {
  const milestones = [
    { year: "2026", event: "FutureCandy", description: "Studio direction locked" },
    { year: "2026", event: "Velvette", description: "Soft-glam artist lane" },
    ...
    { year: "Next", event: "Releases", description: "Publish and repeat" },
  ];
