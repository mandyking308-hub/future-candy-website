    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-border/10 shadow-[0_2px_20px_rgba(0,0,0,0.06)]">
      <div className="container mx-auto px-6 py-2">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 transition-all duration-400 hover:scale-[1.03]">
            <img 
              src={logo} 
              alt="NeonCandy Logo" 
              className="h-16 md:h-20 w-auto object-contain"
            />
            <span className="text-lg md:text-xl font-semibold text-[#2a3a52] tracking-tight">
              NeonCandy<sup className="text-[0.5em] font-normal ml-0.5">™</sup>
            </span>
          </Link>
