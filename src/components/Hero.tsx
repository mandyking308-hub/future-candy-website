  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 md:pt-36">
      <div
        ...
        role="img"
        aria-label="FutureCandy hero visual with warm neon glow and glossy pop studio styling"
      />
      ...
      <div
        className="absolute inset-0 ambient-glow opacity-30"
        style={{
      ...
      <div className="relative z-10 container mx-auto px-4 text-center py-12 md:py-0">
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-4 md:mb-6 animate-fade-in">
          ...
          <span className="block text-2xl sm:text-3xl md:text-4xl mt-4 text-foreground/90 font-medium">AI Pop for the Future</span>
        </h1>
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 md:mb-12 text-foreground/90 animate-fade-in max-w-2xl mx-auto drop-shadow-md leading-relaxed" style={{ animationDelay: "0.4s" }}>
          A digital-first pop studio building artists, songs, videos, and visual worlds with AI-powered creative direction.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center animate-fade-in px-4" style={{ animationDelay: "0.6s" }}>
          ...
          <a href="/music" aria-label="Explore the FutureCandy music catalogue" className="w-full sm:w-auto">
          ...
          <a href="/artists" aria-label="Meet the FutureCandy artists" className="w-full sm:w-auto">
        ...
        <div className="mt-8 animate-fade-in" style={{ animationDelay: "0.8s" }}>
          <Button onClick={toggleAudio} variant="ghost" size="sm" className="gap-2 text-sm text-muted-foreground hover:text-candy-cyan transition-colors">
            {audioPlaying ? <Volume2 className="w-4 h-4" /> : <VolumeX className="w-4 h-4" />}
            {audioPlaying ? `Now Playing: ${trackTitle ?? "Single"}` : "Play a Single"}
          </Button>
        </div>
      </div>
