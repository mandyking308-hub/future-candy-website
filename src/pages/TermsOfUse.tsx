    ...
    >
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "WebPage",
          "name": "Terms of Use - FutureCandy",
          "description": "Website Terms of Use for FutureCandy, governing use of our website and services.",
          "publisher": {
            "@type": "Organization",
            "name": "FutureCandy",
      ...
      <div className="prose prose-invert max-w-none space-y-8">
        <div id="intro" className="glass p-8 rounded-lg scroll-mt-24">
          <p className="text-lg mb-4 text-candy-cyan">
            These Terms of Use govern your access to and use of the FutureCandy website and services. By using our platform, you agree to be bound by these terms. Please read them carefully before proceeding.
          </p>
          <p className="mb-4">
            FutureCandy ("we," "us," or "our") is a private limited company and a subsidiary of HEALTH CHOICES GLOBAL LIMITED, operating under the company number 10941962, with a registered office at 128 City Road, London, United Kingdom, EC1V 2NX.
          </p>
          <p>
        ...
        <section id="definitions" className="glass p-8 rounded-lg scroll-mt-24">
          ...
          <ul className="space-y-2 list-disc list-inside">
            <li><strong>Website:</strong> Refers to the internet properties of FutureCandy.</li>
        ...
        <section id="ip-rights" className="glass p-8 rounded-lg scroll-mt-24">
          ...
          <p className="mb-4">
            All content on the Website, including text, graphics, logos, sounds (unless explicitly offered for license), musical works, software, and compilation of the foregoing, is the exclusive property of FutureCandy or its licensors and is protected by UK and international copyright laws.
          </p>
        ...
        <section id="user-conduct" className="glass p-8 rounded-lg scroll-mt-24">
          ...
          <ol className="space-y-2 list-[lower-alpha] list-inside">
            ...
            <li>Attempt to gain unauthorized access to any portion of the Website, other accounts, computer systems, or networks connected to FutureCandy.</li>
        ...
        <section id="third-party" className="glass p-8 rounded-lg scroll-mt-24">
          ...
          <p>
            The Website may contain links to third-party websites or resources. These links are provided solely as a convenience. FutureCandy has no control over the content of those sites and accepts no responsibility for them or for any loss or damage that may arise from your use of them.
          </p>
        </section>
        ...
        <section id="liability" className="glass p-8 rounded-lg scroll-mt-24">
          ...
          <p>
            In no event shall FutureCandy, its affiliates (including HEALTH CHOICES GLOBAL LIMITED), directors, employees, or agents be liable for damages of any kind, under any legal theory, arising out of or in connection with your use, or inability to use, the Website or Services, including any direct, indirect, special, incidental, consequential, or punitive damages.
          </p>
        </section>
        ...
        <section id="changes" className="glass p-8 rounded-lg scroll-mt-24">
          ...
          <p>
            FutureCandy reserves the right to revise and update these Terms of Use from time to time in our sole discretion. All changes are effective immediately when we post them. Your continued use of the Website following the posting of revised Terms means that you accept and agree to the changes.
          </p>
        </section>
      </div>
    </LegalPageLayout>
