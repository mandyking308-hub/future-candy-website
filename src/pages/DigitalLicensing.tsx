        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <div className="glass p-8 rounded-lg">
              <p className="text-lg">
                This Licensing Policy applies to all digital products, including but not limited to sound libraries, sample packs, loops, MIDI files, and synthesizer presets (collectively, "Products"), purchased or downloaded from NeonCandy.
              </p>
            </div>
            ...
            <section className="glass p-8 rounded-lg">
              ...
              <p className="mb-4">
                Upon purchasing or legally downloading a Product, NeonCandy grants you a worldwide, perpetual, non-exclusive, non-transferable license to use the sounds and musical compositions contained within the Products, subject to the restrictions below.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">1.2. Royalty-Free (Standard Usage)</h3>
              <p>
                Unless otherwise explicitly stated (e.g., in the case of specific premium kits), all standard Products are 100% Royalty-Free for use in your original musical compositions. This means you do not owe NeonCandy any additional royalties or performance fees for commercial exploitation of a composition incorporating the sounds.
              </p>
            </section>
            ...
            <section className="glass p-8 rounded-lg">
              <h2 className="text-2xl font-bold text-candy-cyan mb-4">5. Multilingual Masters and Regional Versions</h2>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.1. Separate Master Recordings</h3>
              <p className="mb-4">
                Each translation or language adaptation generated by NeonCandy is a separate master recording with its own distinct identity and rights.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.2. Ownership</h3>
              <p className="mb-4">
                NeonCandy retains 100% ownership of all multilingual masters and associated metadata, including but not limited to track titles, artwork, and promotional materials.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.3. Licensee Restrictions</h3>
              <p className="mb-4">
                Licensees may not alter, translate, or commission alternate-language versions without prior written consent from NeonCandy.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.4. ISRC Registration</h3>
              <p className="mb-4">
                Each approved multilingual version will receive its own ISRC (International Standard Recording Code) and separate registration entry to ensure accurate royalty collection and rights management.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.5. Quality Assurance</h3>
              <p>
                Where AI-based translation tools are used, NeonCandy reviews lyrical output for cultural sensitivity and artistic integrity before public release. All multilingual works undergo quality control to maintain brand standards.
              </p>
            </section>

            <section className="glass p-8 rounded-lg">
              <h2 className="text-2xl font-bold text-candy-violet mb-4">6. Termination</h2>
              <p>
                NeonCandy reserves the right to terminate this License if you violate any of the terms outlined herein. Upon termination, you must immediately cease all use of the Products and destroy all copies, digital or otherwise.
              </p>
            </section>

            <section className="glass p-8 rounded-lg">
              <h2 className="text-2xl font-bold text-candy-pink mb-4">7. No Refunds for Digital Goods</h2>
              <p>
