        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section className="glass p-8 rounded-lg">
              ...
              <p className="mb-4">
                Each translation or language adaptation generated by FutureCandy is a separate master recording with its own distinct identity and rights.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.2. Ownership</h3>
              <p className="mb-4">
                FutureCandy retains 100% ownership of all multilingual masters and associated metadata, including but not limited to track titles, artwork, and promotional materials.
              </p>
              
              <h3 className="text-xl font-semibold text-candy-pink mt-6 mb-3">5.3. Licensee Restrictions</h3>
              <p className="mb-4">
                Licensees may not alter, translate, or commission alternate-language versions without prior written consent from FutureCandy.
              </p>
              ...
              <p>
                Where AI-based translation tools are used, FutureCandy reviews lyrical output for cultural sensitivity and artistic integrity before public release. All multilingual works undergo quality control to maintain brand standards.
              </p>
            </section>
